...
body: 'ʙʏ anya forger-Bot-MD',         
previewType: 0, thumbnail: fs.readFileSync("./Menu2.jpg"),
sourceUrl: `https://github.com/Davidperdomo16/ANYA-FORGER-BOT-MD.git`}}})
...
body: 'ʙʏ anya forger-Bot',         
previewType: 0, thumbnail: fs.readFileSync("./Menu2.jpg"),
sourceUrl: `    `}}})
let res = await fetch("https://api.dhamzxploit.my.id/api/ytplaymp4?text="+text)
let json = await res.json()
conn.sendFile(m.chat, json.result.url, 'error.mp4', `_𝘈𝘕𝘠𝘈 𝘍𝘖𝘙𝘎𝘌𝘙-𝘉𝘖𝘛 _`, m)}
}catch(e){
